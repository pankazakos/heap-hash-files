...
#define INDEX_NAME "secondary_index.db"
...
int main() {
  ...
  // Κάνουμε εισαγωγή τυχαίων εγγραφών τόσο στο αρχείο κατακερματισμού τις
  // οποίες προσθέτουμε και στο δευτερεύον ευρετήριο
